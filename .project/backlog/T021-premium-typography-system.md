...
- [ ] Add Google Fonts to `base-layout.astro` head
- [ ] Load Cormorant Garamond (400, 600, 700)
- [ ] Load Inter (400, 600, 700)
- [ ] Add font-display: swap for performance
- [ ] Define CSS custom properties in `app.css`
- [ ] Set `--font-display`, `--font-body`, `--font-accent`
