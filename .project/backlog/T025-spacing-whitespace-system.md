...
- [ ] Update Tailwind config with 8px-based spacing scale
...
- [ ] Audit all components for non-8px spacing
...
- [ ] Apply golden ratio progression to sections:
  ```astro
...
- [ ] Add generous margins between card grids:
